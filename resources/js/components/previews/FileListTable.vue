        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                <tr
                    v-for="file in files"
                    :key="file.name"
                    class="border-b dark:border-dark-600 hover:bg-gray-50 dark:hover:bg-dark-800"
                >
                    <td class="px-4 py-3">
                        <div class="w-10 h-10 bg-gray-100 dark:bg-dark-700 rounded flex items-center justify-center overflow-hidden">
                            <img
                    ...
                    <td class="px-4 py-3">
                        <code class="text-xs bg-gray-100 dark:bg-dark-700 px-2 py-1 rounded text-gray-700 dark:text-dark-200">
                            {{ file.name }}
                        </code>
                    </td>
